...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      console.log('Attempting Native Google Authentication...');
      ...
      // Display the actual native error details on screen for easier debugging
  ...
  const handleFacebookSignIn = async () => {
    ...
    try {
      // --- CAPACITOR NATIVE FACEBOOK AUTH SUGGESTION ---
      /*
      ...
      */
      ...
      // --- SIMULATED/MOCK FACEBOOK AUTH FOR TESTING ---
      ...
      setError('Gagal masuk menggunakan akun Facebook.');
    } finally {
      setSocialLoading('');
    }
  };
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between p-6">
      ...
      <div className="text-center pt-8 space-y-3">
        <div className="flex justify-center">
          <div className="bg-gradient-to-tr from-emerald-400 to-teal-500 p-3.5 rounded-2xl shadow-lg shadow-emerald-500/20 text-white animate-pulse">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm w-full mx-auto my-6">
        {error && (
          <div className="mb-4 bg-rose-50 border border-rose-100 p-3 rounded-xl text-rose-600 flex items-start gap-2.5 text-xs font-bold animate-fadeIn">
        ...
        {/* --- SOCIAL MEDIA LOGIN PANEL --- */}
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-slate-200"></div>
          </div>
          <div className="relative flex justify-center text-xs">
            <span className="bg-slate-50 px-3.5 text-slate-400 font-black uppercase tracking-widest text-[9px]">Atau masuk dengan</span>
          </div>
        </div>
